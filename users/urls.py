...
from .views import RegisterSMSSendCode, Register, Login, RefreshToken, PasswordResetRequestSMS, UsernamePasswordResetSMS
...
urlpatterns = [
    ...
    path('password-reset-request-sms/', PasswordResetRequestSMS.as_view(), name='password-reset-request-sms'),
